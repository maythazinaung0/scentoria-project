...
export default function Orders() {
  ...
  async function load() {
    try {
      ...
      // If our debug catch caught an issue:
      if (response.data && response.data.error_debug_message) {
         console.error("🔴 ACTUAL LARAVEL ERROR:", response.data.error_debug_message);
         alert("Laravel Database Error: " + response.data.error_debug_message);
      }
