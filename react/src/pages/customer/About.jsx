        ...
        <div className="bg-nature-bg dark:bg-night-bg text-nature-dark dark:text-night-text transition-colors duration-300">
            ...
            <div className="max-w-5xl mx-auto px-4 text-center pt-28 pb-20">
                <div className="flex items-center justify-center gap-3 mb-6">
                    <ScentoriaLogo className="w-9 h-11 text-nature-olive dark:text-nature-sage" />
                    <h1 className="font-serif text-5xl sm:text-6xl text-nature-dark dark:text-night-text tracking-tight">Scentoria</h1>
                </div>
                <p className="text-nature-muted dark:text-night-muted text-base max-w-xl mx-auto mb-9 leading-relaxed">
                ...
                <div className="flex justify-center gap-4">
                    ...
                    <Link
                        to="/products"
                        className="inline-flex items-center gap-2 px-9 py-3.5 bg-white dark:bg-night-card text-nature-dark dark:text-night-text border border-nature-border/70 dark:border-night-border text-xs uppercase tracking-[0.2em] font-medium transition-all hover:bg-nature-olive hover:text-white dark:hover:bg-nature-olive dark:hover:text-white"
                    >
                    ...
                    <Link
                        to="/scents"
                        className="inline-flex items-center gap-2 px-9 py-3.5 bg-nature-olive dark:bg-nature-sage text-white text-xs uppercase tracking-[0.2em] font-medium transition-all hover:bg-nature-olive-dark dark:hover:bg-nature-olive"
                    >
                        Explore Scents
                    </Link>
                </div>
            ...
            <div className="max-w-5xl mx-auto px-4 mb-24">
                ...
                <h2 className="font-serif text-3xl sm:text-4xl text-center mb-12 text-nature-dark dark:text-night-text">Our Story</h2>
                ...
                <div className="grid md:grid-cols-12 gap-10 items-center">
                    <div className="md:col-span-5 aspect-square overflow-hidden rounded-sm">
                        <img
                            ...
                            className="w-full h-full object-cover filter brightness-90 dark:brightness-75 transition-all"
                        />
                    </div>

                    <div className="md:col-span-7 space-y-4 text-sm text-nature-muted dark:text-night-muted leading-relaxed">
                        ...
                        <div className="flex gap-10 pt-5">
                            <div>
                                <p className="font-serif text-3xl text-nature-olive dark:text-nature-sage">50+</p>
                                <p className={labelClass}>Fragrances</p>
                            </div>
                            <div>
                                <p className="font-serif text-3xl text-nature-olive dark:text-nature-sage">1K+</p>
            ...
            <div className="max-w-5xl mx-auto px-4 mb-24">
                ...
                <h2 className="font-serif text-3xl sm:text-4xl text-center mb-2 text-nature-dark dark:text-night-text">Why Choose Scentoria</h2>
                <p className="text-center text-nature-muted dark:text-night-muted text-sm mb-12">Quality you can trust, prices you'll love.</p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    {[
                        ...
                        <div key={i} className={`${panelClass} p-6 transition-colors hover:border-nature-olive/40 dark:hover:border-nature-sage/40 cursor-default`}>
                            <item.icon className="w-6 h-6 text-nature-olive dark:text-nature-sage mb-4" strokeWidth={1.5} />
                            <h3 className="text-nature-dark dark:text-night-text font-medium text-sm mb-1.5">{item.title}</h3>
                            <p className="text-nature-muted dark:text-night-muted text-xs leading-relaxed">{item.desc}</p>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="max-w-3xl mx-auto px-4 mb-24">
                ...
                <h2 className="font-serif text-3xl sm:text-4xl text-center mb-2 text-nature-dark dark:text-night-text">Frequently Asked Questions</h2>
                <p className="text-center text-nature-muted dark:text-night-muted text-sm mb-10">Everything you need to know before ordering.</p>
                <div className="space-y-3">
                    {faqs.map((faq, i) => (
                        <div key={i} className={`${panelClass} transition-colors hover:border-nature-olive/40 dark:hover:border-nature-sage/40`}>
                            <button
                                onClick={() => setOpenFaq(openFaq === i ? null : i)}
                                className="w-full flex items-center justify-between gap-4 p-5 text-left text-nature-dark dark:text-night-text text-sm font-medium focus:outline-none"
                            >
                                {faq.q}
                                <ChevronDown className={`w-4 h-4 text-nature-muted dark:text-night-muted flex-shrink-0 transition-transform duration-300 ${openFaq === i ? 'rotate-180' : ''}`} strokeWidth={1.5} />
                            </button>
                            {openFaq === i && (
                                <div className="px-5 pb-5 pt-4 text-nature-muted dark:text-night-muted text-sm leading-relaxed border-t border-nature-border/50 dark:border-night-border/50">
                                    {faq.a}
                                </div>
                            )}
                        </div>
            ...
            <div className="max-w-5xl mx-auto px-4 mb-24">
                ...
                <h2 className="font-serif text-3xl sm:text-4xl text-center mb-2 text-nature-dark dark:text-night-text">Get In Touch</h2>
                <p className="text-center text-nature-muted dark:text-night-muted text-sm mb-10">We're here to help you find your perfect fragrance.</p>
                <div className="grid md:grid-cols-2 gap-5">
                    {[
                        ...
                        <div key={i} className={`${panelClass} p-6 flex items-start gap-4 transition-colors hover:border-nature-olive/40 dark:hover:border-nature-sage/40 cursor-default`}>
                            <item.icon className="text-nature-olive dark:text-nature-sage mt-0.5 flex-shrink-0" strokeWidth={1.5} />
                            <div>
                                <p className={`${labelClass} mb-1.5`}>{item.title}</p>
                                <p
                                    className={`text-nature-dark dark:text-night-text text-sm ${item.isMulti ? 'leading-relaxed text-nature-muted dark:text-night-muted' : 'font-medium'}`}
